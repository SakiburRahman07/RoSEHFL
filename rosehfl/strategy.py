...
class ShapeFlStrategy(fl.server.strategy.Strategy):
    ...
    def _effective_probe_payload_cost(
        self,
        *,
    ...
    def _record_probe_payload_cost(
        ...
        *,
        ...
        self.current_cycle_effective_cost_gb += self._effective_probe_payload_cost(
    ...
    def _simulate_candidate_cycle(
        ...
        *,
        ...
        if include_probe_payload:
            effective_cost_gb += self._effective_probe_payload_cost(
                probe_payload_bytes={
                    int(node_id): int(payload_bytes)
