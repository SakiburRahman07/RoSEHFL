...
=======================================
CIFAR variant (32×32) — 3×3 first conv, stride 1, no max-pool.
...
class BasicBlock(nn.Module):
    """ResNet basic block (two 3×3 convolutions with skip connection)."""
...
class ResNet18(nn.Module):
    """
    ResNet-18 for CIFAR-100 (32×32).

    The classifier layer is named ``linear`` and is used for
