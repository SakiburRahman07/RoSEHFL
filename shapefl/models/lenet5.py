...
===============================================
Architecture adapted for Fashion-MNIST (28×28 grayscale, 10 classes).
...
class LeNet5(nn.Module):
    ...
    Architecture:
        Input:  1×28×28
        Conv1:  1→6,  5×5 kernel, padding=2  →  6×28×28
        Pool1:  2×2 max pool                 →  6×14×14
        Conv2:  6→16, 5×5 kernel             → 16×10×10
        Pool2:  2×2 max pool                 → 16×5×5
        FC1:    400→120
        FC2:    120→84
